...
function toRequest(p: ProductDetails): ProductRequest {
  return {
    ...
    supplierId: p.supplier?.supplierId ?? null,
        ...
        {isLoading ? (
          ...
          >
            <div className="flex-1 space-y-4 px-6 py-4">
              ...
              {!isNew && (
                <div>
                  <span className="mb-1 block text-sm font-medium text-gray-400">Supplier</span>
                  <p className="rounded-md border border-dashed bg-gray-50 px-3 py-2 text-sm text-gray-400 cursor-not-allowed select-none">
