...
SELECT setval(
    pg_get_serial_sequence('purchasing.suppliers', 'supplier_id'),
    (SELECT MAX(supplier_id) FROM purchasing.suppliers)
);
...
-- ============================================================
-- crm schema seed (Customers) converted from instnwnd.sql
-- ============================================================
