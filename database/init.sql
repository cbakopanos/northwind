...
CREATE TABLE "CustomerCustomerDemo" (
  ...
  CONSTRAINT "FK_CustomerCustomerDemo" FOREIGN KEY ("CustomerTypeID") REFERENCES crm."CustomerDemographics" ("CustomerTypeID"),
...
CREATE TABLE "Territories" (
  ...
  CONSTRAINT "FK_Territories_Region" FOREIGN KEY ("RegionID") REFERENCES sales_org."Region" ("RegionID")
);
